...
public class AnyEntityDetail extends MetaData{
	 ...
	 */
	public AnyEntityDetail(Integer anyId, Integer anyEntityDetailId) {
		this.anyId = anyId;
	...
	@PreRemove
	@PreUpdate
	private void preOperation() throws UException {
		if (anyId!= null && anyEntityDetailId!=null) {
			this.id= new AnyEntityDetailPK(anyId, anyEntityDetailId);
		}else {

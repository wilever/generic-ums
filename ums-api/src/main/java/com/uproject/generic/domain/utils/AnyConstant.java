...
/**
 * The Class AnyControllerConstant for SwaggerDocumentation.
 */
public class AnyConstant {
	...
	public static final String PATH_TO_CONTROLLER = "/anycontroller";
	
	/** The Constant CONTROLLER_NAME. */
	public static final String CONTROLLER_NAME = "AnyController";
	
	/** The Constant CONTROLLER_DESCRIPTION. */
	public static final String CONTROLLER_DESCRIPTION = "Allow to perform CRUD operations over ANY_ENTITY";
	...
	public static final String GET_OPERATION_VALUE = "Retrieve data from database";
	
	/** The Constant GET_OPERATION_NOTE. */
	public static final String GET_OPERATION_NOTE = 	"It can return data by " 
														+ "search and filter parameters. "
														+ "If exist one or more properties "
														+ "that depend on other table "
														+ " link by a foreginKey it is "
														+ "retrieve from database, then "
														+ "it is show as a propertie of this data. ";
	...
	public static final String ID_VALUE = "Id of data to be process";
	
	/** The Constant ID_TYPE. */
	public static final String ID_DATA_TYPE = "int";
	
	/** The Constant ID_PARAM_TYPE. */
	public static final String ID_PARAM_TYPE = "query";
	...
	public static final String LOGICAL_DATA_TYPE = "String";

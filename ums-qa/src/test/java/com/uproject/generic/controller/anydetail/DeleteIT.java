...
public class DeleteIT {
	...
	public void Success() throws Exception {
		...
		AnyEntityDetail entityDeleted = repository.findOne(entity.getId());
	...
	public void DataNotValidate() throws Exception {
		...
		response = assistant.
						delete(	"?anyId="+dataNotValid.getId().getAnyId()+
								"&anyEntityDetailId="+dataNotValid.getId().getAnyEntityDetailId()+
								"&logical="+logical);
		expected = assistant.
						getResponse(
								assistant.getRule(), 
